...
public:
    ...
    {
        stdgpu::construct_at(stdgpu::to_address(_begin + i), _value);
    }
...
public:
    ...
    operator()(const index64_t i)
    {
        ...
        stdgpu::construct_at(stdgpu::to_address(_output_begin + i), _begin[i]);
    }
...
{
    stdgpu::construct_at(p, stdgpu::forward<Args>(args)...);
}
